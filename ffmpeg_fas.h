...
__extern fas_error_type   fas_open_video  (fas_context_ref_type *context_ptr, AVFormatContext *pFormatCtx);
...
__extern seek_boolean_type fas_get_seek_completed  (fas_context_ref_type context);
